Action()
{
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=username", "Value=bobo", ENDITEM, 
		"Name=password", "Value=123456", ENDITEM, 
		"Name=passwordConfirm", "Value=123456", ENDITEM, 
		"Name=firstName", "Value=Bobo", ENDITEM, 
		"Name=lastName", "Value=Fofo", ENDITEM, 
		"Name=address1", "Value=London", ENDITEM, 
		"Name=address2", "Value=789412", ENDITEM, 
